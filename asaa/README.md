# ASAA — Autonomous Security Assessment Agent (SP-II prototype)

A runnable reference implementation of the ASAA design documented in the
Senior Project I report. It realises the three-mode assessment pipeline,
continuous CVE monitoring, the per-target authorisation invariant, a
hash-chained audit log, and bilingual (Arabic/English) PDF reporting, behind a
single web dashboard.

This is an academic prototype for demonstration. It does not by itself certify
ECC-2:2024 or PDPL compliance (see SP-I Ch.6 limitations).
